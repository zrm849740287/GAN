...
# dataset = Dataset(r'E:\ZRM\data\\nmi_pair\\trainB', r'E:\ZRM\data\\nmi_pair\\trainA', transform=None)
# dataloader = DataLoader(dataset=dataset, batch_size=opt.batch_size, shuffle=False, num_workers=0)# 加载数据
dataloader = DataLoader(
    ImageDataset("E:\data\zrm_dataset\\nmi_pair\\train", transforms_=transforms_),
...
#     ImageDataset("E:\ZRM\data\\nmi_pair\\test" % opt.dataset_name, mode="val", transforms_=transforms_),
#     batch_size=1,
#     shuffle=False,
#     num_workers=1,
# )
